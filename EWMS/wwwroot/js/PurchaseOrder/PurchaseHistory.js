/* =========================================================
   PURCHASE HISTORY PAGE FOR PURCHASING STAFF
========================================================= */
...
async function loadHistoryPurchaseOrders() {
    try {
        ...
        const url = `/PurchaseOrder/GetHistoryPurchaseOrders?search=${encodeURIComponent(search)}`;
        ...
        row.innerHTML = `
            ...
            <td>
                ${order.status === 'Cancelled'
                    ...
                    : `<a class="btn btn-sm btn-outline-primary" href="/PurchaseOrder/Details/${order.purchaseOrderId}">
